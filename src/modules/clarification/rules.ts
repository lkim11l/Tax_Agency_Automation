...
const commonRules: CompletenessRule[] = [
  ...
  { fieldName: "authority_document", label: "Документ о полномочиях", question: "Укажите документ, подтверждающий полномочия подписанта.", minimumConfidence: 0.75, allowManualConfirmation: true, required: true },
  { fieldName: "authority_number", label: "Номер документа о полномочиях", question: "Укажите номер документа о полномочиях подписанта.", minimumConfidence: 0.75, allowManualConfirmation: true, required: true },
  { fieldName: "authority_date", label: "Дата документа о полномочиях", question: "Укажите дату документа о полномочиях подписанта.", minimumConfidence: 0.75, allowManualConfirmation: true, required: true },
